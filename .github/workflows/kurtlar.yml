  ...
  yayin:
    ...
    - name: 🎬 Yayın scriptini oluştur
      run: |
        ...
        # ===================== YAYIN AYARLARI =====================
        VIDEO_URL = "https://catcast.ismailturret.workers.dev/fanatikprimekurtlarvadisi.m3u8"
        LOGO_URL = "https://i.hizliresim.com/kpx9cyq.png"
