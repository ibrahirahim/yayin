...
STREAM_KEY = "mutlusinema"
rtmp_server = f"{RTMP_URL}/{STREAM_KEY}"

# ===================== YAYIN AYARLARI =====================
VIDEO_URL = "https://catcast.ismailturret.workers.dev/50717.m3u8"  # Değiştir!
LOGO_URL = "https://raw.githubusercontent.com/mutlumedya/yayin/refs/heads/main/sinema.png"  # Değiştir!
