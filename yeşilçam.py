...
STREAM_KEY = "tvgoyesilcam1"
rtmp_server = f"{RTMP_URL}/{STREAM_KEY}"

# ===================== YAYIN AYARLARI =====================
VIDEO_URL = "https://catcast.ismailturret.workers.dev/fanatikmaxyesilcam.m3u8"  # Değiştir!
LOGO_URL = "https://i.hizliresim.com/lhtzckh.png"  # Değiştir!
