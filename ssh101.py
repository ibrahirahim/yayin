...
# ===================== YAYIN AYARLARI =====================
VIDEO_URL = "https://catcast.ismailturret.workers.dev/playercinema-premium5.m3u8"  # Değiştir!
LOGO_URL = "https://i.hizliresim.com/bxgiz3t.png"  # Değiştir!
...
command = [
    ...
    '-i', LOGO_URL,
    '-filter_complex',
    '[0:v]scale=1920:1080:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:black[v0];'
